...
CREATE TABLE characters (id INTEGER PRIMARY KEY, NAME text, MOTTO text, species_id INTEGER, author_id INTEGER);
CREATE TABLE character_books (id (id INTEGER PRIMARY KEY, character_id INTEGER, book_id INTEGER);