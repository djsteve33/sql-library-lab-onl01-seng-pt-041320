...
def select_character_names_and_number_of_books_they_are_in
  "SELECT character.name, COUNT (*) as book_count from character_books JOIN characters ON character_books.character_id = character.id GROUP BY characters.name ORDER BY "
end
